...
%% constants
% here are some constants I frequently use. 
% If you have the greytak lab matlab setup, you can call constants_assign
% to get them in your workspace, if desired. The only one we actually need
