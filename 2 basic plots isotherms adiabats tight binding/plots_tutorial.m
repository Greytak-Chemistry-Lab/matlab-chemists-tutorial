...
%% try log plot again in a different way
...
%% overlay plots
% You can overlay two sets of axes: usually you have the same x scale, and
% different y scales on each side, for example. This is tricky.
...
%% you can go back and adjust panels individually 
% by using the subplot command to bring attention to one of the plots. Just
% be sure to use the same number of rows and columns or it might redraw the
% whole figure and erase your work.
subplot(2,2,1)
ylabel('X^2')